...
class Drawing():
    def __init__(self, screen, sc_map):
        ...
        self.textures = {
            1: pygame.image.load(f'{self.rootDir}pictures/wall1.png').convert(),
            2: pygame.image.load(f'{self.rootDir}pictures/wall2.png').convert(),
            3: pygame.image.load(f'{self.rootDir}pictures/wall3.png').convert(),
            4: pygame.image.load(f'{self.rootDir}pictures/wall4.png').convert(),
            5: pygame.image.load(f'{self.rootDir}pictures/wall5.png').convert(),
            6: pygame.image.load(f'{self.rootDir}pictures/wall6.png').convert(),
            'S': pygame.image.load(f'{self.rootDir}pictures/sky1.png').convert()
        }
